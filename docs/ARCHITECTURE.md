...
| Deployment | **Live:** https://hesitate-v2.onrender.com (`/health`, `/gate/demo`, `/token`, `/call.html` all confirmed 200 OK). One production bug found and fixed: environment variables were never actually set on the deployed service |
